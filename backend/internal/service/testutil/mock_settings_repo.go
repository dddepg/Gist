...
// Source: internal/repository/settings_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/repository/settings_repository.go -destination=internal/service/testutil/mock_settings_repo.go -package=testutil
//
