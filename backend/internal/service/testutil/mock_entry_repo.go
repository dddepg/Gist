...
// Source: internal/repository/entry_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/repository/entry_repository.go -destination=internal/service/testutil/mock_entry_repo.go -package=testutil
//
